...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-http-proxy/node_modules/http-proxy/lib/http-proxy/passes/web-outgoing.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-http-proxy/node_modules/http-proxy/lib/http-proxy/passes/web-outgoing.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-http-proxy/node_modules/http-proxy/lib/http-proxy/passes/</a> &#187; web-outgoing.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   * @api private
   */
  removeChunked: <span class="fstat-no" title="function not covered" >function removeChunked(req, res, proxyRes) {</span>
...
&nbsp;
   ...
   * @api private
   */
  setConnection: <span class="fstat-no" title="function not covered" >function setConnection(req, res, proxyRes) {</span>
<span class="cstat-no" title="statement not covered" >    if (req.httpVersion === '1.0') {</span>
...
&nbsp;
  setRedirectHostRewrite: <span class="fstat-no" title="function not covered" >function setRedirectHostRewrite(req, res, proxyRes, options) {</span>
...
<span class="cstat-no" title="statement not covered" >      var target = url.parse(options.target);</span>
<span class="cstat-no" title="statement not covered" >      var u = url.parse(proxyRes.headers['location']);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      proxyRes.headers['location'] = u.format();</span>
   ...
   * @api private
   */
  writeHeaders: <span class="fstat-no" title="function not covered" >function writeHeaders(req, res, proxyRes, options) {</span>
<span class="cstat-no" title="statement not covered" >    var rewriteCookieDomainConfig = options.cookieDomainRewrite,</span>
        preserveHeaderKeyCase = options.preserveHeaderKeyCase,
        rawHeaderKeyMap,
        setHeader = <span class="fstat-no" title="function not covered" >function(key, header) {</span>
...
<span class="cstat-no" title="statement not covered" >            header = common.rewriteCookieDomain(header, rewriteCookieDomainConfig);</span>
          }
...
<span class="cstat-no" title="statement not covered" >        var key = proxyRes.rawHeaders[i];</span>
<span class="cstat-no" title="statement not covered" >        rawHeaderKeyMap[key.toLowerCase()] = key;</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    Object.keys(proxyRes.headers).forEach(<span class="fstat-no" title="function not covered" >function(key) {</span></span>
<span class="cstat-no" title="statement not covered" >      var header = proxyRes.headers[key];</span>
...
&nbsp;
   ...
   * @api private
   */
  writeStatusCode: <span class="fstat-no" title="function not covered" >function writeStatusCode(req, res, proxyRes) {</span>
