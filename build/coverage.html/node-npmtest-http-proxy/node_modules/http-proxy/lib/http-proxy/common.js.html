...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-http-proxy/node_modules/http-proxy/lib/http-proxy/common.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-http-proxy/node_modules/http-proxy/lib/http-proxy/common.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-http-proxy/node_modules/http-proxy/lib/http-proxy/</a> &#187; common.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
common.setupOutgoing = <span class="fstat-no" title="function not covered" >function(outgoing, options, req, forward) {</span>
...
<span class="fstat-no" title="function not covered" >    function(e) {</span> <span class="cstat-no" title="statement not covered" >outgoing[e] = options[forward || 'target'][e]; </span>}
  );
&nbsp;
<span class="cstat-no" title="statement not covered" >  outgoing.method = req.method;</span>
...
<span class="cstat-no" title="statement not covered" >  var target = options[forward || 'target'];</span>
<span class="cstat-no" title="statement not covered" >  var targetPath = target &amp;&amp; options.prependPath !== false</span>
    ? (target.path || '')
    : '';
&nbsp;
  //
  ...
  //
<span class="cstat-no" title="statement not covered" >  var outgoingPath = !options.toProxy</span>
 ...
 */
&nbsp;
common.setupSocket = <span class="fstat-no" title="function not covered" >function(socket) {</span>
 ...
 * @api private
 */
common.getPort = <span class="fstat-no" title="function not covered" >function(req) {</span>
<span class="cstat-no" title="statement not covered" >  var res = req.headers.host ? req.headers.host.match(/:(\d+)/) : '';</span>
&nbsp;
 ...
 * @api private
 */
common.hasEncryptedConnection = <span class="fstat-no" title="function not covered" >function(req) {</span>
 ...
 */
&nbsp;
common.urlJoin = <span class="fstat-no" title="function not covered" >function() {</span>
    //
 ...
 * @api private
 */
common.rewriteCookieDomain = <span class="fstat-no" title="function not covered" >function rewriteCookieDomain(header, config) {</span>
<span class="cstat-no" title="statement not covered" >  if (Array.isArray(header)) {</span>
<span class="cstat-no" title="statement not covered" >    return header.map(<span class="fstat-no" title="function not covered" >function (headerElement) {</span></span>
<span class="cstat-no" title="statement not covered" >      return rewriteCookieDomain(headerElement, config);</span>
    });
  }
<span class="cstat-no" title="statement not covered" >  return header.replace(cookieDomainRegex, <span class="fstat-no" title="function not covered" >function(match, prefix, previousDomain) {</span></span>
<span class="cstat-no" title="statement not covered" >    var newDomain;</span>
<span class="cstat-no" title="statement not covered" >    if (previousDomain in config) {</span>
<span class="cstat-no" title="statement not covered" >      newDomain = config[previousDomain];</span>
    } else <span class="cstat-no" title="statement not covered" >if ('*' in config) {</span>
<span class="cstat-no" title="statement not covered" >      newDomain = config['*'];</span>
    } else {
      //no match, return previous domain
<span class="cstat-no" title="statement not covered" >      return match;</span>
    }
<span class="cstat-no" title="statement not covered" >    if (newDomain) {</span>
      //replace domain
<span class="cstat-no" title="statement not covered" >      return prefix + newDomain;</span>
    } else {
      //remove domain
 ...
 * @api private
 */
<span class="fstat-no" title="function not covered" >function hasPort(host) {</span>
