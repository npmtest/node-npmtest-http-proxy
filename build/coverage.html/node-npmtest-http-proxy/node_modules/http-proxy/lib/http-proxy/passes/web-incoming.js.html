...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-http-proxy/node_modules/http-proxy/lib/http-proxy/passes/web-incoming.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-http-proxy/node_modules/http-proxy/lib/http-proxy/passes/web-incoming.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-http-proxy/node_modules/http-proxy/lib/http-proxy/passes/</a> &#187; web-incoming.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
&nbsp;
  deleteLength: <span class="fstat-no" title="function not covered" >function deleteLength(req, res, options) {</span>
...
&nbsp;
   ...
   */
&nbsp;
  timeout: <span class="fstat-no" title="function not covered" >function timeout(req, res, options) {</span>
...
&nbsp;
   ...
   */
&nbsp;
  XHeaders: <span class="fstat-no" title="function not covered" >function XHeaders(req, res, options) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var encrypted = req.isSpdy || common.hasEncryptedConnection(req);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    ['for', 'port', 'proto'].forEach(<span class="fstat-no" title="function not covered" >function(header) {</span></span>
...
&nbsp;
   ...
   */
&nbsp;
  stream: <span class="fstat-no" title="function not covered" >function stream(req, res, options, _, server, clb) {</span>
&nbsp;
    // And we begin!
...
<span class="cstat-no" title="statement not covered" >      var forwardReq = (options.forward.protocol === 'https:' ? https : http).request(</span>
        common.setupOutgoing(options.ssl || {}, options, req, 'forward')
      );
&nbsp;
      // error handler (e.g. ECONNRESET, ECONNREFUSED)
      // Handle errors on incoming request as well as it makes sense to
<span class="cstat-no" title="statement not covered" >      var forwardError = createErrorHandler(forwardReq, options.forward);</span>
...
<span class="cstat-no" title="statement not covered" >    var proxyReq = (options.target.protocol === 'https:' ? https : http).request(</span>
      common.setupOutgoing(options.ssl || {}, options, req)
    );
&nbsp;
    // Enable developers to modify the proxyReq before headers are sent
<span class="cstat-no" title="statement not covered" >    proxyReq.on('socket', <span class="fstat-no" title="function not covered" >function(socket) {</span></span>
...
<span class="cstat-no" title="statement not covered" >      proxyReq.setTimeout(options.proxyTimeout, <span class="fstat-no" title="function not covered" >function() {</span></span>
...
<span class="cstat-no" title="statement not covered" >    var proxyError = createErrorHandler(proxyReq, options.target);</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function createErrorHandler(proxyReq, url) {</span>
<span class="cstat-no" title="statement not covered" >      return <span class="fstat-no" title="function not covered" >function proxyError(err) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    proxyReq.on('response', <span class="fstat-no" title="function not covered" >function(proxyRes) {</span></span>
...
<span class="cstat-no" title="statement not covered" >      proxyRes.on('end', <span class="fstat-no" title="function not covered" >function () {</span></span>
