...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-http-proxy/node_modules/http-proxy/lib/http-proxy/passes/ws-incoming.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-http-proxy/node_modules/http-proxy/lib/http-proxy/passes/ws-incoming.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-http-proxy/node_modules/http-proxy/lib/http-proxy/passes/</a> &#187; ws-incoming.js</div>
</div>
<div class="body">
...
module.exports = {
   ...
   */
&nbsp;
  checkMethodAndHeader : <span class="fstat-no" title="function not covered" >function checkMethodAndHeader(req, socket) {</span>
...
&nbsp;
   ...
   */
&nbsp;
  XHeaders : <span class="fstat-no" title="function not covered" >function XHeaders(req, socket, options) {</span>
...
&nbsp;
   ...
   * @api private
   */
  stream : <span class="fstat-no" title="function not covered" >function stream(req, socket, options, head, server, clb) {</span>
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >    var proxyReq = (common.isSSL.test(options.target.protocol) ? https : http).request(</span>
...
<span class="cstat-no" title="statement not covered" >    proxyReq.on('response', <span class="fstat-no" title="function not covered" >function (res) {</span></span>
      // if upgrade event isn't going to happen, close the socket
<span class="cstat-no" title="statement not covered" >      if (!res.upgrade) <span class="cstat-no" title="statement not covered" >socket.end();</span></span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    proxyReq.on('upgrade', <span class="fstat-no" title="function not covered" >function(proxyRes, proxySocket, proxyHead) {</span></span>
<span class="cstat-no" title="statement not covered" >      proxySocket.on('error', onOutgoingError);</span>
&nbsp;
      // Allow us to listen when the websocket has completed
<span class="cstat-no" title="statement not covered" >      proxySocket.on('end', <span class="fstat-no" title="function not covered" >function () {</span></span>
...
<span class="cstat-no" title="statement not covered" >      socket.write(</span>
        Object.keys(proxyRes.headers).reduce(<span class="fstat-no" title="function not covered" >function (head, key) {</span>
<span class="cstat-no" title="statement not covered" >          var value = proxyRes.headers[key];</span>
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function onOutgoingError(err) {</span>
